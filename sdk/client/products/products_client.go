...
type ClientService interface {
	...
	ListProduct(params *ListProductParams, opts ...ClientOption) (*ListProductOK, error)
...
/*
CreateProduct Add a product into the database
*/
...
/*
ListProduct Returns a product
*/
func (a *Client) ListProduct(params *ListProductParams, opts ...ClientOption) (*ListProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
